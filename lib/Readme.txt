...
2)По условию статический класс Plugins должен реализовать интерфейс IPluginFactory. Реализация интерфейсов статическими классами невозможна, если конечно не было задачи сделать его как Singleton. 

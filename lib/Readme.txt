...
но в то же время по содержанию данного интерфейса, класс Plugins, 
который должен реализовать интерфейс выступает в качестве
глобального контейнера для плагинов (на это также косвено указывает и то, что по условию класс должен быть статическим,
а следовательно и являться "глобальной точкой" из любой части приложения), 
...
2)По условию статический класс Plugins должен реализовать интерфейс IPluginFactory. Реализация интерфейсов статическими классами невозможна. 
